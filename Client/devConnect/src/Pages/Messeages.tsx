...
const MessagePage = () => {
    ...
    console.log(unfollowedMessageSenders);
            ...
            <div className="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
                ...
                <div className="hidden md:flex w-80 flex-shrink-0 border-r border-slate-200/70 bg-white/60 backdrop-blur-sm flex-col h-screen shadow-lg">
                    ...
                    <div className="flex-1 overflow-y-auto">
                        <div className="p-4">
                            <h2 className="text-lg font-semibold mb-4 text-slate-700">Followed people Conversations</h2>
                        ...
                        <h2 className="text-lg font-semibold mb-4 text-slate-700">Unfollowed people Conversations</h2>
                        <div className="space-y-2">
