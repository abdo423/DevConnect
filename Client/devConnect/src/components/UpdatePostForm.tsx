...
const UpdatePostModal = ({post}: UpdatePostModalProps) => {
    ...
    const {handleSubmit, formState: {isSubmitting}, setValue, watch} = form;
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="flex flex-row align-middle justify-center" variant="ghost" size="icon"
                            ...
                            render={({}) => (
                                <FormItem>
                                    ...
                                    <div className="relative h-48 w-full overflow-hidden rounded-md">
                                        <img
                                            src={imageUrlValue || post.image || "https://dummyimage.com/600x400/8c8c8c/fff"}
                                            alt="Post preview"
