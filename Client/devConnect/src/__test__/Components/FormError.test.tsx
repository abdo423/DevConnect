...
describe('FormError', () => {
  ...
  it('handles long error messages', () => {
    const longErrorMessage =
      'This is a very long error message that should still be rendered correctly without breaking the component layout or functionality';
  ...
  describe('edge cases', () => {
    ...
    it('handles whitespace-only message', () => {
      ...
      expect(
        screen.getByTestId('form-error').querySelector('span')
      ).toBeInTheDocument();
    });
