...
describe('CommentController.createComment', () => {
  ...
  it('should create a comment successfully', async () => {
    ...
    jest
      ...
      .mockResolvedValue(
        mockComment as unknown as Awaited<
          ReturnType<typeof CommentService.createComment>
        >,
      );
  ...
  it('should return 400 if validation fails - content too short', async () => {
    ...
    jest
      .spyOn(CommentService, 'createComment')
      .mockRejectedValue(mockValidationError);
...
describe('CommentController.updateComment', () => {
  ...
  it('should return 200 when comment is updated successfully', async () => {
    ...
    jest
      ...
      .mockResolvedValue(
        updatedComment as unknown as Awaited<
          ReturnType<typeof CommentService.updateComment>
        >,
      );
...
describe('CommentController.getCommentsByPost', () => {
  ...
  it('should return 200 when comments are retrieved successfully', async () => {
    ...
    jest
      ...
      .mockResolvedValue(
        fakeComments as unknown as Awaited<
          ReturnType<typeof CommentService.getCommentsByPost>
        >,
      );
