...
describe("Post Controller", () => {
    ...
    describe("createPost", () => {
        it("should create a post and return status 201", async () => {
            ...
            jest.spyOn(postService, "createPost")
                .mockResolvedValue(mockPost as unknown as Awaited<ReturnType<typeof postService.createPost>>);
        ...
        it("should return 500 if an unexpected error occurs", async () => {
            ...
            jest.spyOn(postService, "createPost").mockRejectedValue(new Error("Database error"));
    ...
    describe("getPosts", () => {
        it("should get all posts and return status 200", async () => {
            ...
            jest.spyOn(postService, "getAllPosts")
                .mockResolvedValue(mockPosts as unknown as Awaited<ReturnType<typeof postService.getAllPosts>>);
        ...
        it("should return 500 if an unexpected error occurs", async () => {
            jest.spyOn(postService, "getAllPosts").mockRejectedValue(new Error("Database error"));
    ...
    describe("deletePost", () => {
        it("should delete a post and return status 200", async () => {
            ...
            jest.spyOn(postService, "deletePost")
                .mockResolvedValue(mockDeletedPost as unknown as Awaited<ReturnType<typeof postService.deletePost>>);
        ...
        it("should return 500 if an unexpected error occurs", async () => {
            ...
            jest.spyOn(postService, "deletePost").mockRejectedValue(new Error("Database error"));
    ...
    describe("updatePost", () => {
        it("should update a post and return status 200", async () => {
            ...
            jest.spyOn(postService, "updatePost")
                .mockResolvedValue(mockUpdatedPost as unknown as Awaited<ReturnType<typeof postService.updatePost>>);

            await postController.updatePost(req as Request, res as Response);

            expect(postService.updatePost).toHaveBeenCalledWith("mockPostId", req.body);
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
        ...
        it("should return 404 if post not found", async () => {
            req = {params: {id: "nonExistentPostId"}, body: {title: "Some Title"}};
            ...
            expect(postService.updatePost).toHaveBeenCalledWith("nonExistentPostId", req.body);
            expect(statusMock).toHaveBeenCalledWith(404);
            expect(jsonMock).toHaveBeenCalledWith({
                message: "Post not found"
            });
        ...
        it("should return 500 if an unexpected error occurs", async () => {
            ...
            jest.spyOn(postService, "updatePost").mockRejectedValue(new Error("Database error"));
    ...
    describe("likePost", () => {
        it("should like a post and return status 200 with 'Post liked'", async () => {
            ...
            jest.spyOn(postService, "likePost").mockResolvedValue({
                alreadyLiked: false,
                likes: [
                    {user: new Types.ObjectId("507f1f77bcf86cd799439011"), createdAt: new Date()},
                    {user: new Types.ObjectId("507f1f77bcf86cd799439012"), createdAt: new Date()},
        ...
        it("should return 404 if post not found", async () => {
            ...
            expect(postService.likePost).toHaveBeenCalledWith("nonExistentPostId", userId);
            expect(statusMock).toHaveBeenCalledWith(404);
            expect(jsonMock).toHaveBeenCalledWith({
                message: "Post not found"
            });
        ...
        it("should return 500 if an unexpected error occurs", async () => {
            ...
            jest.spyOn(postService, "likePost").mockRejectedValue(new Error("Database error"));
    ...
    describe("getCommentsByPostIdArray", () => {
        it("should return comments for a valid postId and status 200", async () => {
            ...
            jest.spyOn(postService, "getCommentsByPostId")
                .mockResolvedValue(mockComments as unknown as Awaited<ReturnType<typeof postService.getCommentsByPostId>>);

            await postController.getCommentsByPostIdArray(req as Request, res as Response);

            expect(postService.getCommentsByPostId).toHaveBeenCalledWith("mockPostId");
            expect(statusMock).toHaveBeenCalledWith(200);
        ...
        it("should return 404 if post is not found", async () => {
            ...
            expect(postService.getCommentsByPostId).toHaveBeenCalledWith("nonExistentPostId");
            expect(statusMock).toHaveBeenCalledWith(404);
            expect(jsonMock).toHaveBeenCalledWith({
                message: "Post not found"
            });
        ...
        it("should return 500 if an unexpected error occurs", async () => {
            ...
            jest.spyOn(postService, "getCommentsByPostId").mockRejectedValue(new Error("Database error"));
