...
describe("Profile Controller", () => {
    ...
    describe("getProfileById", () => {
        it("should return 200 and user data when successful", async () => {
            ...
            expect(profileService.getProfileById).toHaveBeenCalledWith(targetUserId, userId);
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith(mockUser);
        });
    ...
    describe("followUser", () => {
        it("should follow user successfully", async () => {
            ...
            expect(profileService.followUser).toHaveBeenCalledWith(targetUserId, userId);
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
                user: mockUser,
    ...
    describe("updateProfile", () => {
        ...
        it("should update profile successfully", async () => {
            const mockUpdatedUser = {id: userId, username: "newusername", bio: "Updated bio"};
            (profileService.updateProfile as jest.Mock).mockResolvedValue(mockUpdatedUser);
            ...
            expect(profileService.updateProfile).toHaveBeenCalledWith(userId, userId, updateData);
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
